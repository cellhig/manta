...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categorias = $em->getRepository('MantaFacturationBundle:Categoria')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Manta\FacturationBundle\Form\CategoriaType', $categorium);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorium);
        $editForm = $this->createForm('Manta\FacturationBundle\Form\CategoriaType', $categorium);
