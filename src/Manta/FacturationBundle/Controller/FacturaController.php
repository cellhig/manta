...
class FacturaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $facturas = $em->getRepository('MantaFacturationBundle:Factura')->findAll();
    ...
    {
        $factura = new Factura();
        $form = $this->createForm('Manta\FacturationBundle\Form\FacturaType', $factura);
    ...
    {
        $deleteForm = $this->createDeleteForm($factura);
        $editForm = $this->createForm('Manta\FacturationBundle\Form\FacturaType', $factura);
