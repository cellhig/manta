...
use Manta\FacturationBundle\Entity\Producto;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $productos = $em->getRepository('MantaFacturationBundle:Producto')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Manta\FacturationBundle\Form\ProductoType', $producto);
    ...
    {
        $deleteForm = $this->createDeleteForm($producto);
        $editForm = $this->createForm('Manta\FacturationBundle\Form\ProductoType', $producto);
