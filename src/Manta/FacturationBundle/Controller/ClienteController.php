...
use Manta\FacturationBundle\Entity\Cliente;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clientes = $em->getRepository('MantaFacturationBundle:Cliente')->findAll();
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('Manta\FacturationBundle\Form\ClienteType', $cliente);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('Manta\FacturationBundle\Form\ClienteType', $cliente);
